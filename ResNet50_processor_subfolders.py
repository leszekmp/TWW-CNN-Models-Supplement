...
model_id="ResNet50_"+set_number+"_"+run_number
print(model_id)
...
#set X,Y values for val data
#(valX, valY) = (val_data,val_labels)
...
# load the ResNet50 network, head FC layers left off
...
# Unfreeze all layers for training; remember 0-based count!
